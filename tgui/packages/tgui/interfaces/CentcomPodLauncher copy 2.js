...
const CentcomPodLauncherContent = (props, context) => {
  ...
  return (
    <Window.Content scrollable>
          <Flex>
            <Flex minWidth = "200px" direction="column">
            ...
            <Flex direction="column">
              <Flex.Item m={marginer} height="100%">
                <PageComponent />
              </Flex.Item>
              <Flex.Item m={marginer}>
                <PresetsPage />
            ...
            <Flex direction="column" minWidth="30%">
              <Flex.Item m={marginer} grow = {1} shrink={1} basis="50px">
                      ...
                      <Flex.Item>
                        <Tabs>
                          {TABPAGES.map((page, i) => (
                            <Tabs.Tab
                              key={i}
                              selected={i === tabPageIndex}
                              onClick={() => setTabPageIndex(i)}>
                              {page.title}
                            </Tabs.Tab>
                            ))}
                          </Tabs>
...
const TabPod = (props, context) => {
  ...
  return (
    <Section>
      <Box
      className={classes(['supplypods64x64', data.styleChoice])}/>
    </Section>
  );
};
...
const PresetsPage = (props, context) => {
  ...
  return ( 
    <Section title="Presets" minHeight="100%" maxHeight="150px" overflowY="scroll">
      <Tabs vertical>
        {PRESETS.map((page, i) => (
          <Tabs.Tab
            key={i}

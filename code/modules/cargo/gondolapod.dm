...
/mob/living/simple_animal/pet/gondola/gondolapod/verb/check()
	...
	var/total = linked_pod.launchList.len
	if (total)	
...
/mob/living/simple_animal/pet/gondola/gondolapod/proc/close()
	opened = FALSE
	update_icon()

/mob/living/simple_animal/pet/gondola/gondolapod/proc/sparks()
